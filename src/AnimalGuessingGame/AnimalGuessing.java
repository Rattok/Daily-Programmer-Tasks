...
public class AnimalGuessing {
    ...
    public static void main(String[] args) {
        ...
        Node head = n;
        while (true) {
            System.out.print("Welcome to Animal Guess. Think of an animal and type 'y' to start! --> ");
            if (sc.nextLine().charAt(0) != 'y') {
                System.out.println("It seems you did not want to play. Goodbye!");
                System.exit(0);
            }
            while (n.left != null) {
            ...
            if (sc.nextLine().charAt(0) == 'y') {
                ...
                System.out.print("What question would distinguish your animal from " + n.question + "? -->");
